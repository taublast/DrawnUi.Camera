    ...
    public partial class MainPage
    {
        ...
        private async Task TestPhotoGallerySave()
        {
            try
            {
                ...
                using var font = new SKFont { Size = 60 };
                canvas.DrawText($"Test Photo", 500, 450, SKTextAlign.Center, font, paint);
                canvas.DrawText(DateTime.Now.ToString("HH:mm:ss"), 500, 550, SKTextAlign.Center, font, paint);
